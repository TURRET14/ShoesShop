...
CREATE TABLE ShopOrderDetail (ID INT PRIMARY KEY IDENTITY(0,1), ShopOrderID INT REFERENCES ShopOrder ON DELETE CASCADE NOT NULL, ProductID INT REFERENCES Product NOT NULL, Amount INT NOT NULL);